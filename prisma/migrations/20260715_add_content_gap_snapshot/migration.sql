...
-- CreateTable
CREATE TABLE "ContentGapSnapshot" (
    "id" TEXT NOT NULL,
    "platform" TEXT NOT NULL DEFAULT 'youtube',
    "source" TEXT NOT NULL DEFAULT 'trong_nuoc',
    "data" TEXT NOT NULL,
    "generatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ContentGapSnapshot_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Post_relevanceStatus_idx" ON "Post"("relevanceStatus");

-- CreateIndex
CREATE INDEX "Post_platform_relevanceStatus_idx" ON "Post"("platform", "relevanceStatus");
...
-- CreateIndex
CREATE INDEX "ContentGapSnapshot_platform_source_idx" ON "ContentGapSnapshot"("platform", "source");

-- CreateIndex
CREATE INDEX "ContentGapSnapshot_generatedAt_idx" ON "ContentGapSnapshot"("generatedAt");
